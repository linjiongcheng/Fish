...
//		middleFish = BitmapFactory.decodeResource(resources, R.drawable.middle1000);
		middleFish = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(resources, R.drawable.middle1000), 180, 90, true);
