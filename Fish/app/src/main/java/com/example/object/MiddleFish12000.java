...
public class MiddleFish12000 extends EnemyFish{
    ...
    public void initBitmap() {
        ...
        middleFish = BitmapFactory.decodeResource(resources, R.drawable.middle12000);
