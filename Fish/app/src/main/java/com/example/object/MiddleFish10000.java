...
//        middleFish = BitmapFactory.decodeResource(resources, R.drawable.middle1200);
        middleFish = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(resources, R.drawable.middle10000), 220, 110, true);
