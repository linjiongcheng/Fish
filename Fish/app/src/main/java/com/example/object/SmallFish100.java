...
//        smallFish = BitmapFactory.decodeResource(resources, R.drawable.small1200);
        smallFish = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(resources, R.drawable.small100), 140, 70, true);
