...
//        smallFish = BitmapFactory.decodeResource(resources, R.drawable.small1000);
        smallFish = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(resources, R.drawable.small10), 100, 50, true);
