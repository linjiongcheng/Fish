...
//		smallFish = BitmapFactory.decodeResource(resources, R.drawable.small10);
		smallFish = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(resources, R.drawable.small1), 60, 30, true);
